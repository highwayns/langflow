...
class GraphStoreFrontendNode(FrontendNode):
    def add_extra_fields(self) -> None:
        ...
        if self.template.type_name == "ArangoGraph":
            extra_field = TemplateField(
                name="weaviate_url",
                field_type="str",
                required=True,
            ...
            extra_fields.extend((extra_field, extra_field2))
        elif self.template.type_name == "KuzuGraph":
        ...
        elif self.template.type_name == "NebulaGraph":
    ...
    def add_extra_base_classes(self) -> None:
        self.base_classes.extend(("BaseRetriever", "GraphStoreRetriever"))
    ...
    def format_field(field: TemplateField, name: Optional[str] = None) -> None:
        ...
        if field.name == "texts":
            ...
            # when instantiating the graphstores
